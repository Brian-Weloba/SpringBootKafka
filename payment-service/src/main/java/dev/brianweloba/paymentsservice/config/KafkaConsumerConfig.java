...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String,EventEnvelope<Object>> consumerFactory(){
        ...
        configProps.put(JsonDeserializer.TRUSTED_PACKAGES, "dev.brianweloba.lib");
        configProps.put(JsonDeserializer.USE_TYPE_INFO_HEADERS, false);
        configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "dev.brianweloba.lib.EventEnvelope");
